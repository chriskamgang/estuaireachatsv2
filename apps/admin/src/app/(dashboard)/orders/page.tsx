...
import { Search, Eye, Calendar, ShoppingCart, Loader2 } from 'lucide-react';
...
export default function OrdersPage() {
  ...
  const columns: Column<Order>[] = [
    { key: 'orderNumber', name: 'N° Commande', render: (o) => <span className="font-mono font-medium text-primary">{o.orderNumber}</span> },
    { key: 'date', name: 'Date', render: (o) => formatDate(o.createdAt) },
    { key: 'client', name: 'Client', render: (o) => <span className="font-medium">{o.buyer ? `${o.buyer.firstName} ${o.buyer.lastName}` : '-'}</span> },
    { key: 'vendeur', name: 'Vendeur', render: (o) => o.seller ? `${o.seller.firstName} ${o.seller.lastName}` : '-' },
    { key: 'articles', name: 'Articles', render: (o) => <span>{o.details.length} article(s)</span> },
    { key: 'total', name: 'Total', render: (o) => <span className="font-semibold">{formatPrice(o.total)}</span> },
    { key: 'paiement', name: 'Paiement', render: (o) => <StatusBadge status={o.paymentStatus || 'PENDING'} /> },
    { key: 'statut', name: 'Statut', render: (o) => <StatusBadge status={o.status} /> },
    {
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-3">
        ...
        <h1 className="text-2xl font-bold text-dark">Commandes</h1>
      </div>
