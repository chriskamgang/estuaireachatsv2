...
import { ArrowLeft, Edit2, Loader2, Package, Tag, BarChart3 } from 'lucide-react';
  ...
  if (error || !product) {
    return (
      <div className="py-16 text-center">
        ...
        <button onClick={() => router.push('/products')} className="text-sm text-primary font-medium hover:underline mt-2">
          Retour a la liste
        </button>
      </div>
    );
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-gray-3">Detail du produit</p>
          </div>
        </div>
        <Link href={`/products/${product.id}/edit`} className="flex items-center gap-2 px-4 py-2.5 bg-primary text-white rounded-lg text-sm font-medium hover:bg-primary/90 transition">
      ...
      <div className="grid grid-cols-3 gap-6">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-xl shadow-sm p-6 space-y-4">
            ...
            <div>
              <p className="text-xs text-gray-3">Marque</p>
              <p className="text-sm font-medium text-dark">{product.brand?.name || '-'}</p>
            </div>
            <div>
