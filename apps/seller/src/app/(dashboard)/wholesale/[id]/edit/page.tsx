...
export default function EditWholesaleProductPage() {
  ...
  const [existingImages, setExistingImages] = useState<{ url: string; isMain: boolean; order: number }[]>([]);
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-gray-3">Modifiez les informations du produit en gros</p>
          </div>
        </div>
        {aiDone && (
      ...
      <div className="bg-white rounded-xl shadow-sm">
        ...
        <form onSubmit={handleSubmit} className="p-6">
              ...
              {suggestedImages.length > 0 && (
                <div>
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    <label className="text-sm font-medium text-gray-2">Images similaires suggerees par l&apos;IA</label>
                  </div>
                  <div className="grid grid-cols-5 gap-3">
            ...
            <div className="space-y-5 max-w-2xl">
              ...
              <div>
                ...
                <div className="space-y-2">
                  ...
                  {paliers.length === 0 && (
                    <p className="text-sm text-gray-3 text-center py-4">Aucun palier de prix. Cliquez sur &quot;Ajouter un palier&quot; pour commencer.</p>
                  )}
                </div>
              </div>
            </div>
          ...
          <div className="flex justify-end gap-3 mt-8 pt-6 border-t border-gray-5">
            <Link href="/wholesale" className="px-5 py-2.5 border border-gray-5 text-gray-2 rounded-lg text-sm font-medium hover:bg-gray-6 transition">
              Annuler
            </Link>
